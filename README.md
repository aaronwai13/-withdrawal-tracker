...
- `icon.svg`: icon 原稿，方便之後改字或改色
- `icon-192.png`: PWA / Android 基本 icon
- `apple-touch-icon.png`: iPhone / iPad 加到主畫面 icon
...
- custom PWA icon 採用白底、`額` 字，並保留 `icon.svg`、`icon-192.png`、`apple-touch-icon.png`
